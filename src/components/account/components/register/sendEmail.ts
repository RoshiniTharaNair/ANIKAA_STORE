      ...
      html: `
        <div style="background-color: #8a5436; color: #522a14; padding: 50px; text-align: center;">
          <div style="background-color: #fafafa; color: #522a14; padding: 50px; text-align: center;">
            <img src="https://www.kamyaarts.com/cdn/shop/files/IMG_3719.jpg?v=1696598913&width=390" alt="Anikaa Logo" style="width: 500px; height: auto;">
            <h1 style="font-weight: 500; margin-bottom: 20px; font-style: italic; font-size: 26px;">Welcome to Anikaa, ${first_name}.</h1>
