...
>SPECIAL PROJECTS</Link></ul>
  ...
  <h3 className="txt-black" style={{fontWeight:"bold"}}>CATEGORIES</h3>
  <ul className="list-none mt-3" style={{lineHeight:"3em", textTransform:"uppercase", fontSize:"8px"}}>
    {topLevelCategories && topLevelCategories.map(category => (
      <li key={category.id}>
        <Link className="option-li" href={`/explore/${category.handle}`} 
        ...
        >
          ...
          <div className="" style={{fontSize: "10.5px", fontFamily:"Avenir Next LT W02 Regular",letterSpacing:"0.1em" }}>
            ...
            <ul className="list-none mt-3" style={{lineHeight:"3em", textTransform:"uppercase", fontSize:"8px"}}>
              ...
              <li ><Link className="option-li" href="/policy/privacypolicy">Privacy Policy</Link></li>
              <li><Link className="option-li" href="/policy/refundandcancellation">Refund and cancellation Policy</Link></li>
              <li><Link className="option-li" href="/policy/shippinganddelivery">Shipping and Delivery</Link></li>
              <li><Link className="option-li" href="/policy/termsandconditions">Terms and Conditions</Link></li>
              {/* <li><Link className="option-li" href="/policy/">QUESTIONS AND ANSWERS</Link></li> */}
              {/* <li><Link className="option-li" href="/policy/">FOR LEGAL ENTITIES</Link></li>
              <li><Link className="option-li" href="/policy/">BLOG</Link></li> */}
              <li><Link className="option-li" href="/policy/contact">ASK A QUESTION</Link></li>
          ...
          <div className="" style={{fontSize: "10.5px", fontFamily:"Avenir Next LT W02 Regular",letterSpacing:"0.1em" }}>
            ...
            <ul className="list-none mt-3" style={{lineHeight:"3em", textTransform:"uppercase", fontSize:"8px"}}>
              {/* Replace with actual links or text */}
              <li><Link className="option-li" href="/policy/careers">CAREERS</Link></li>
              <li><Link className="option-li" href="/policy/corporategiftsandspecialoccasions">Corporate Gifts and Special Occasions</Link></li>
              <li><Link className="option-li" href="/policy/socialresponsibility">Social Responsibility</Link></li>
              <li><Link className="option-li" href="/policy/tailormadecreativesolutions">Tailormade creative solutions</Link></li>
              <li><Link className="option-li" href="/policy/environmentalresponsibility">ENVIRONMENTAL RESPONSIBILITY</Link></li>
            </ul>
                  </div>
                  </div>
        ...
        <li className="option-list" key={category.id}>
          ...
          {showForClients && (
            <ul className="dropdown-content list-none mt-3" style={{lineHeight:"3em", textTransform:"uppercase", fontSize:"8px"}}>
              {/* Replace with actual links or text */}
              <li ><Link className="option-list" href="/policy/privacypolicy">Privacy Policy</Link></li>
              <li><Link className="option-list" href="/policy/refundandcancellation">Refund and cancellation Policy</Link></li>
              <li><Link className="option-list" href="/policy/shippinganddelivery">Shipping and Delivery</Link></li>
              <li><Link className="option-list" href="/policy/termsandconditions">Terms and Conditions</Link></li>
              {/* <li><Link className="option-list" href="/policy/">QUESTIONS AND ANSWERS</Link></li> */}
              {/* <li><Link className="option-list" href="/policy/">FOR LEGAL ENTITIES</Link></li>
              <li><Link className="option-list" href="/policy/">BLOG</Link></li> */}
              <li><Link className="option-list" href="/policy/contact">ASK A QUESTION</Link></li>
        ...
        <div className="dropdown-section">
          ...
          {showAboutCompany && (
            <ul className="dropdown-content list-none mt-3" style={{lineHeight:"3em", textTransform:"uppercase", fontSize:"8px"}}>
              {/* Replace with actual links or text */}
              <li><Link className="option-list" href="/policy/careers">CAREERS</Link></li>
              <li><Link className="option-list" href="/policy/corporategiftsandspecialoccasions">Corporate Gifts and Special Occasions</Link></li>
              <li><Link className="option-list" href="/policy/socialresponsibility">Social Responsibility</Link></li>
              <li><Link className="option-list" href="/policy/tailormadecreativesolutions">Tailormade creative solutions</Link></li>
              <li><Link className="option-list" href="/policy/environmentalresponsibility">ENVIRONMENTAL RESPONSIBILITY</Link></li>
              </ul>
          )}
        </div>
                  </div>
          ...
          <div className="" style={{fontSize: "10.5px", fontFamily:"Avenir Next LT W02 Regular",letterSpacing:"0.1em" }}>
            ...
            <div className="mt-1" style={{color:"#7F3F98", fontWeight: "bolder",letterSpacing:"0.2em", fontFamily:"Avenir Next LT W02 Regular", fontSize:"10px"}}> <span style={{fontWeight: 900}}>(+91) 9362204990</span></div>
            ...
            <div className="mt-1"  style={{color:"#713787", fontWeight: "bolder",letterSpacing:"0.2em", fontFamily:"Avenir Next LT W02 Regular", fontSize:"10px", textTransform:"uppercase"}}>
              <a href="mailto:anikaadesignssolutions@gmail.com" >anikaadesignssolutions@gmail.com</a>
            </div>
  ...
  © 2024 Powered and secured by Anikaa Designs Solutions.
  </p>
...
<div className="payment-footer" style={{   gap: "10px" }}>
  ...
  <img className="apple-img" src="/applepay.png" alt="applepay" />
