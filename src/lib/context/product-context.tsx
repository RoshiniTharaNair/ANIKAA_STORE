...
interface ProductContext {
  ...
  addToCart: (variantId: string, designPreferences: string, designImages: string[]) => void; // Updated signature
}
...
export const ProductProvider = ({
  ...
  const addToCart = (variantId: string, designPreferences: string, designImages: string[]) => {
    if (variant) {
      console.log("Adding to Cart - Variant ID: ", variant.id, " Quantity: ", quantity, " Design Preferences: ", designPreferences);
      addItem({
        variantId: variant.id,
        quantity,
        design_preferences: designPreferences,
        design_images: designImages, // New field for design images
      });
    }
  };
