...
const AddressSelect = ({ addresses, cart }: AddressSelectProps) => {
  // Log the list of addresses and selected address when they are updated
  ...
  const handleSelect = (id: string) => {
    ...
    // console.log("Addresses : ", addresses); // Log selected address when user selects one

    if (savedAddress) {
      // console.log("Address selected: ", savedAddress); // Log selected address when user selects one
      cartUpdate({
